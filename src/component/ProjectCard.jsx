...
const projects = [
  {
    ...
    githubLink: "#",
    youtubeLink: "#",
    tags: ["#ReactJs", "#CSS", "#Tailwind CSS", "#NodeJs", "#ExpressJs", "#MongoDB", "#Postman", "#Cloudinary.com", "#WebSocket"],
    accent: "#7c3aed",
  ...
  },
  {
    ...
    title: "Weather App",
    description:
      "A real-time weather application that provides current weather data, forecasts, and location-based weather information with a clean, intuitive UI.",
    image: null,
    previewBg: "linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)",
    previewLabel: "Weather Dashboard",
    liveLink: "#",
    githubLink: "#",
    youtubeLink: "#",
